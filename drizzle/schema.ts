...
export const candidateProfiles = mysqlTable(
  "candidate_profiles",
  {
    ...
    qualification: varchar("qualification", { length: 240 })
      .notNull()
      .default("B.Pharm / M.Pharm"),
    experienceYears: int("experience_years").notNull().default(2),
    currentRole: varchar("current_role", { length: 160 })
      .notNull()
      .default("QA / IPQA Associate"),
...
export const companyContacts = mysqlTable(
  ...
  table => [
    ...
    uniqueIndex("company_contact_unique_idx").on(
      table.companyId,
      table.contactType,
      table.contactValue
    ),
...
export const vacancies = mysqlTable(
  "vacancies",
  {
    ...
    employmentRoute: mysqlEnum("employment_route", [
      "walk_in",
      "direct",
      "unverified",
    ])
    ...
    status: mysqlEnum("status", ["active", "expired", "unverified"])
      .notNull()
      .default("unverified"),
...
export const applications = mysqlTable(
  ...
  table => [
    ...
    uniqueIndex("application_user_vacancy_idx").on(
      table.userId,
      table.vacancyId
    ),
  ]
...
export const monitoringSchedules = mysqlTable(
  "monitoring_schedules",
  {
    ...
    cronExpression: varchar("cron_expression", { length: 80 })
      .notNull()
      .default("0 0 3 * * *"),
    ...
    deliveryTarget: mysqlEnum("delivery_target", [
      "owner_notification",
      "gmail_draft",
      "github_export",
    ])
